...
PL=[
 ...
 p(33.0836,131.1206,17,"bed","r","Kurokawa &middot; DeepSpot",
   ...
   "Night 1 &middot; 17 Nov","1 h 59 m from Fukuoka via Hita and the falls","Booked &middot; Maye","ok"),
 ...
 p(32.6580,131.1830,18,"bed","l","Gokase",
   ...
   "Night 2 &middot; 18 Nov","16 min from Takachiho, either way","Booked &middot; Maye","ok"),
 ...
 p(31.3680,131.3350,19,"alt","r","Cape Toi",
   "Wild horses grazing on an open headland at the southern end of the Nichinan coast.",
   "19 Nov &middot; if you sleep at Nichinan","30 min below Obi"),
]
